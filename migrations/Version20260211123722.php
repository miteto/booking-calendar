 ...
 */
final class Version20260211123722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\PostgreSQLPlatform) {
            $this->addSql('CREATE TABLE slot (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, date DATE NOT NULL, start_time TIME(0) WITHOUT TIME ZONE NOT NULL, end_time TIME(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
            $this->addSql('CREATE UNIQUE INDEX uniq_slot_date_start ON slot (date, start_time)');
            ...
            $this->addSql('CREATE TABLE slot (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, UNIQUE INDEX uniq_slot_date_start (date, start_time), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
